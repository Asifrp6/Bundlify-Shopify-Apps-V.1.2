...
export default function DeliveryOptions({ options, onChange }) {
  ...
  return <BlockStack gap="300">
    ...
    <Button disabled={options.length >= 5} onClick={() => onChange([...options, { frequency: Object.keys(schedules).find(f => !options.some(o => o.frequency === f)) || "Monthly", discount: 0 }])}>Add delivery option</Button>
  </BlockStack>;
}
